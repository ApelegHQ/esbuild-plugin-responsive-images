...
import * as x from 'respimg+file:./hubble_arp143.png?sizes=10w,40w&outputFormats=jpeg,avif,webp';

assert.equal(x.width, 10);
assert.equal(x.height, 7);
assert.equal(x.originalWidth, 2000);
assert.equal(x.originalHeight, 1333);
assert.match(
	x.src,
	/^http:\/\/invalid\/assets\/hubble_arp143\.10w-[^./]+\.jpeg$/,
);
...
assert.match(
	x.sources[0][1],
	/^http:\/\/invalid\/assets\/hubble_arp143\.10w-[^./]+\.jpeg 10w\s*,\s*http:\/\/invalid\/assets\/hubble_arp143\.40w-[^./]+\.jpeg 40w$/,
);
...
assert.match(
	x.sources[1][1],
	/^http:\/\/invalid\/assets\/hubble_arp143\.10w-[^./]+\.avif 10w\s*,\s*http:\/\/invalid\/assets\/hubble_arp143\.40w-[^./]+\.avif 40w$/,
);
...
assert.match(
	x.sources[2][1],
	/^http:\/\/invalid\/assets\/hubble_arp143\.10w-[^./]+\.webp 10w\s*,\s*http:\/\/invalid\/assets\/hubble_arp143\.40w-[^./]+\.webp 40w$/,
);
